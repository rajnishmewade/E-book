...
<div class="container-fluid p-3 bg-light">
    <div class="row">
        <div class="col-md-3 text-success">
            <h3><i class="fa-solid fa-bookmark"></i>Ebooks</h3>    
        </div>
<!--        <div class="col-md-6">
        ...
        <div class="col-md-3">
            <c:if test="${not empty userobj}">
                ...
                <a data-toggle="modal" data-target="#exampleModalLong" class="btn btn-primary text-white">
            ...
            <c:if test="${empty userobj}">
                ...
                <i class="fa-regular fa-user"></i>Register</a>
            </c:if>
        </div>
    </div>
</div>
